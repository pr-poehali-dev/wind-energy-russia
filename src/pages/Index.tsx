        ...
        <main className="md:ml-56 flex-1 px-6 md:px-12 py-16 space-y-24" style={{ maxWidth: "calc(100vw)" }}>
          ...
          <section id="system" className="section-enter mb-24">
            ...
            <p className="text-sm leading-relaxed mb-8" style={{ color: "hsl(var(--foreground))" }}>
              Единая энергетическая система (ЕЭС) России — крупнейшая в мире по охватываемой территории. Она включает
              генерирующие мощности, системы передачи и распределения электроэнергии, объединённые в единое технологическое целое.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              {[
                { icon: "Zap", title: "ТЭС — Тепловые", color: "hsl(var(--doc-accent))", text: "Основа российской энергетики. Работают на природном газе, угле и мазуте. Установленная мощность — около 165 ГВт." },
                { icon: "Waves", title: "ГЭС — Гидро", color: "hsl(197, 80%, 40%)", text: "Россия входит в топ-5 по установленной гидромощности. Крупнейшие — Саяно-Шушенская, Красноярская ГЭС." },
                { icon: "Atom", title: "АЭС — Атомные", color: "hsl(28, 80%, 45%)", text: "11 АЭС с 37 энергоблоками. Росатом — мировой лидер по строительству реакторов за рубежом." },
                { icon: "Wind", title: "ВИЭ — Возобновляемые", color: "hsl(145, 60%, 42%)", text: "Солнечные и ветровые ЭС. Суммарная мощность ВЭС — около 2 ГВт, менее 1% от общей." },
              ].map((c) => (
            ...
            <div className="border-l-2 pl-4 py-1" style={{ borderLeftColor: "hsl(var(--doc-accent))" }}>
              <p className="text-xs leading-relaxed" style={{ color: "hsl(var(--doc-muted))" }}>
                <strong style={{ color: "hsl(var(--doc-dark))" }}>Особенности:</strong> протяжённость линий электропередачи превышает
                2,5 млн км. Значительная часть населённых пунктов удалена от централизованных сетей и использует местные
                дизельные генераторы, что создаёт нишу для малой ветроэнергетики.
              </p>
            </div>
          </section>
